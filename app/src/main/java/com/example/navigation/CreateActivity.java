...
public class CreateActivity extends AppCompatActivity {
    ...
    private EditText editTextRegisterFullName, editTextRegisterEmail, editTextRegisterDoB, editTextRegisterMobile, editTextRegisterPwd, editTextRegisterConfirmPwd, editTextRegisterAadhaarNumber;
 ...
 //*****************************************************************************************************************************
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CreateActivity.this,OwnerActivity.class);
...
//*****************************************************************************************************************************************
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String textAadhaarNumber = editTextRegisterAadhaarNumber.getText().toString();
                String textGender;       //cant obtain the value before verifying if any button was selected or not

                //Validate Mobile number using Matcher and Pattern (Regular Expression)
                String mobileRegex = "[6-9][0-9]{9}";  //First no. can be{6,7,8,9} and rest nos. can be any number.
                Matcher mobileMatcher;
                Pattern mobilePattern = Pattern.compile(mobileRegex);
                mobileMatcher = mobilePattern.matcher(textMobile);

                if(TextUtils.isEmpty(textFullName)){
                    Toast.makeText(CreateActivity.this, "Please enter your full name", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(CreateActivity.this, "Please select your gender", Toast.LENGTH_LONG).show();
                    radioButtonRegisterGenderSelected.setError("Gender is required");
                    radioButtonRegisterGenderSelected.requestFocus();
                }else if(TextUtils.isEmpty(textMobile)){
                    Toast.makeText(CreateActivity.this, "Please enter your Mobile Number", Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.setError("Mobile number is required");
                    editTextRegisterMobile.requestFocus();
                }else if(textMobile.length()!=10){
                    Toast.makeText(CreateActivity.this, "Please re-enter your Mobile Number", Toast.LENGTH_LONG).show();
                    editTextRegisterMobile.setError("Mobile number should be in 10 digits");
                    editTextRegisterMobile.requestFocus();
                    ...
                    Toast.makeText(CreateActivity.this, "Password is too week ", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(CreateActivity.this, "Password Confirmation is required", Toast.LENGTH_SHORT).show();
                    editTextRegisterConfirmPwd.setError("Please enter same password");
                    editTextRegisterConfirmPwd.requestFocus();
                    //Clear the entered password
                    editTextRegisterConfirmPwd.clearComposingText();
                }else if(textAadhaarNumber.length()!=12){
                    //Toast.makeText(CreateActivity.this, "Aadhaar Number  should be of 12 digits ", Toast.LENGTH_SHORT).show();
                    editTextRegisterAadhaarNumber.setError("Aadhaar Number  should be of 12 digits");
                    editTextRegisterAadhaarNumber.requestFocus();
                }else{
                    textGender = radioButtonRegisterGenderSelected.getText().toString();
                    progressBar.setVisibility(View.VISIBLE);
                    registerUser(textFullName, textEmail, textDoB, textGender, textMobile, textPwd, textAadhaarNumber);
                }
            }
        });
    }
//**************************************************End of OnCreate Method*************************************************************************************************************************************************
    ...
    private void registerUser(String textFullName, String textEmail, String textDoB, String textGender, String textMobile, String textPwd, String textAadhaarNumber) {
        ...
        //Create User Profile
        auth.createUserWithEmailAndPassword(textEmail, textPwd).addOnCompleteListener(CreateActivity.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    ReadWriteUserDetails writeUserDetails = new ReadWriteUserDetails (textDoB, textGender, textMobile, textEmail, textAadhaarNumber);
